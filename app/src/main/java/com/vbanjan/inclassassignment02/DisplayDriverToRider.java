...
int flag=-1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final DocumentReference docRef=db.collection("Trips").document(message.messageId);
        docRef.addSnapshotListener(new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot snapshot,
                ...
                if (snapshot != null && snapshot.exists()) {
                    ...
                    snapshot.get("Status");
                    if(snapshot.get("Status").toString().contentEquals("Cancelled")){
                        AlertDialog.Builder builder = new AlertDialog.Builder(getContext());
                        builder.setTitle("Ride cancelled by Rider!!")
...
//
                ...
                if (results[0] < 10) {
                    ...
                    builder.setTitle("Pick Up Rider?")
                            .setMessage("Within 10m of Rider!")
                            .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialogInterface, int i) {
