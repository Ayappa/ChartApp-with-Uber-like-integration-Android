    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FinishTrip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                builder.setTitle("Are you sure you want to cancell the ride")
                        .setMessage("go back to chat room?")
        ...
        docRef.addSnapshotListener(new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot snapshot,
                ...
                if (snapshot != null && snapshot.exists()) {
                    ...
                    if(flag==0) {
                        Toast.makeText(getContext(), "Driver is about to start", Toast.LENGTH_SHORT).show();

                        sb.append("https://maps.googleapis.com/maps/api/directions/json?origin=" + DriverLat + "," + DriverLng +
                                "&destination=" + toLat + "," + toLng + "&waypoints=via:" + fromLat + "," + fromLng + "&key=AIzaSyCjQlEN9SKDCtC30zy7grp-lyhPjEv792Q");
                        new DownloadDirection().execute(String.valueOf(sb));

                    }else{
                        Toast.makeText(getContext(), "Driver is on the way to pick you", Toast.LENGTH_SHORT).show();
                        ...
                        sb.append("https://maps.googleapis.com/maps/api/directions/json?origin=" + DriverLat + "," + DriverLng +
                                "&destination=" + fromLat + "," + fromLng + "&key=AIzaSyCjQlEN9SKDCtC30zy7grp-lyhPjEv792Q");
                        new DownloadDirectionPolyLine().execute(String.valueOf(sb));
                    }
                    flag=1;
...
//Log.d("ayappa","poinys====="+polyline);
    ...
    class DownloadDirectionPolyLine extends AsyncTask<String,Void,ArrayList> {
        List<List<HashMap<String, String>>> point = new ArrayList<List<HashMap<String, String>>>();
